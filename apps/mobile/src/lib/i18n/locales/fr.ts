...
export const fr: Translations = {
  ...
  notifications: {
    ...
    types: {
      ...
      memberAdded: 'Un participant a été ajouté',
      memberClaimed: 'Quelqu’un a pris sa place',
      memberRenamed: 'Un participant a été renommé',
      memberDetached: 'Une place a été libérée',
