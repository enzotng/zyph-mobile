...
export const fr: Translations = {
  ...
  newTrip: {
    ...
    whoIsGoing: 'Qui part ?',
    whoIsGoingBody:
      'Ajoute leurs prénoms maintenant et leur part compte dès la première dépense. Ils pourront prendre leur place plus tard avec le lien d’invitation.',
    addNamePlaceholder: 'Prénom',
    you: 'Toi',
    later: 'Plus tard',
    removeName: 'Retirer {{name}}',
    duplicateName: 'Deux personnes portent ce prénom.',
    ghostAddFailedTitle: 'Voyage créé',
    ghostAddFailed: 'Impossible d’ajouter : {{names}}. Ajoute-les depuis l’écran participants.',
  },
  tripPreferences: {
  ...
  joinTrip: {
    ...
    whoAreYou: 'Qui es-tu ?',
    isThisYou: 'Choisis ton prénom pour que tes dépenses tombent au bon endroit.',
    joiningAs: 'Tu rejoins {{trip}}',
    notInList: 'Je ne suis pas dans la liste',
    noFreeSlots: 'Personne n’attend encore de prénom.',
    reclaimTitle: 'Reprendre ta place',
    reclaimBody: 'Tu faisais partie de ce voyage. Ton historique de dépenses revient avec toi.',
    reclaimCta: 'Je la reprends',
    slotTaken: 'Quelqu’un vient de prendre cette place.',
  },
  documents: {
    title: 'Documents',
  ...
  notifications: {
    ...
    types: {
      memberJoined: '{{actor}} a rejoint le voyage',
      memberLeft: 'Un membre a quitté le voyage',
      memberRemoved: 'On t’a retiré d’un voyage',
      memberAdded: '{{actor}} a ajouté {{name}}',
      memberClaimed: '{{actor}} a rejoint en tant que {{name}}',
      memberRenamed: '{{actor}} a renommé un participant',
      memberDetached: '{{actor}} a libéré la place de {{name}}',
      memberDetachedSelf: '{{actor}} a libéré ta place',
  ...
  group: {
    ...
    notJoined: 'N’a pas encore rejoint',
    manageMember: 'Gérer {{name}}',
    remind: 'Relancer',
    remindMessage: '{{name}}, ta place sur {{title}} t’attend. Prends-la ici : {{url}}',
    renameMember: 'Renommer',
    renamePromptTitle: 'Renommer cette place',
    addParticipant: 'Ajouter un participant',
    addParticipantTitle: 'Ajouter un participant',
    addParticipantFailedTitle: 'Ajout impossible',
    renameFailedTitle: 'Renommage impossible',
    detach: 'Libérer la place',
    confirmDetachTitle: 'Libérer cette place ?',
    confirmDetachBody:
