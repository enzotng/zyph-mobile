...
export const en = {
  ...
  taxonomy: {
    ...
    activity: {
      ...
      excursion: 'Excursion / hike',
      show: 'Show / concert',
      sport: 'Sport / gear rental',
      nature: 'Nature / beach / view',
      nightlife: 'Nightlife / club',
      wellness: 'Spa / wellness',
      experience: 'Class / workshop / tasting',
    },
    shopping: {
      _root: 'Shopping',
      souvenirs: 'Souvenirs',
    ...
    fees: {
      _root: 'Fees & admin',
      bank: 'Bank / FX / ATM fees',
      tax: 'Taxes / tourist tax',
      visa: 'Visa / entry admin',
  ...
  tripForm: {
    ...
    inboxCopied: 'Copied!',
    inboxShare: 'Share',
    inboxRegenerate: 'Regenerate',
    inboxRegenerateConfirmTitle: 'Regenerate the address?',
    inboxRegenerateConfirmBody:
      'The old address and any auto-forward rules pointing to it will stop working immediately.',
    inboxAutoValidate: 'Auto-validate imports',
    inboxAutoValidateHint: 'Skips the review step - extracted events are added straight away.',
    inboxPrivacyNote:
      'Emails sent here are analysed by our import service. We only keep the extracted events.',
    inboxError: 'Something went wrong. Try again.',
  },
  newTrip: {
    title: 'New trip',
    ...
    whoIsGoingBody:
      'Add their first names now and their share is counted from the first expense. They can claim their place later with the invite link.',
    addNamePlaceholder: 'First name',
    you: 'You',
    later: 'Later',
    removeName: 'Remove {{name}}',
    duplicateName: 'Two people share this name.',
    ghostAddFailedTitle: 'Trip created',
    ghostAddFailed: 'Could not add: {{names}}. Add them from the participants screen.',
  },
  tripPreferences: {
  ...
  joinTrip: {
    ...
    isThisYou: 'Pick your name so your expenses land in the right place.',
    joiningAs: 'Joining {{trip}}',
    notInList: 'I am not in the list',
    noFreeSlots: 'No one is waiting for a name yet.',
    reclaimTitle: 'Take your place back',
    reclaimBody: 'You were part of this trip. Your expense history comes back with you.',
    reclaimCta: 'Take it back',
    slotTaken: 'Someone just took this place.',
  },
  documents: {
    title: 'Documents',
    add: 'Add a document',
  ...
  analytics: {
    ...
    byPerson: 'By person',
    paidLabel: 'Paid',
    shareLabel: 'Their share',
    byDay: 'By day',
    perDay: '{{amount}} a day on average',
    budget: 'Budget',
    ...
    invalidBudget: 'Enter a valid amount',
    emptyTitle: 'No spending yet',
    emptyBody: 'Add expenses to see the trip’s stats.',
    errorTitle: 'Could not load stats',
    errorBody: 'Something went wrong. Tap to retry.',
  },
  places: {
  ...
  notifications: {
    ...
    types: {
      ...
      memberAdded: '{{actor}} added {{name}}',
      memberClaimed: '{{actor}} joined as {{name}}',
      memberRenamed: '{{actor}} renamed a participant',
      memberDetached: '{{actor}} released {{name}}’s spot',
      memberDetachedSelf: '{{actor}} released your spot',
  ...
  group: {
    ...
    remind: 'Remind',
    remindMessage: '{{name}}, your place on {{title}} is waiting. Take it here: {{url}}',
    renameMember: 'Rename',
    renamePromptTitle: 'Rename this place',
    addParticipant: 'Add a participant',
    addParticipantTitle: 'Add a participant',
    addParticipantFailedTitle: 'Could not add',
    renameFailedTitle: 'Could not rename',
    detach: 'Free up the place',
    confirmDetachTitle: 'Free up this place?',
    confirmDetachBody:
      '{{name}} keeps their expense history, and the place goes back on the list for someone else to claim.',
    detachBlockedTitle: 'This place has a history',
    detachBlockedBody:
      '{{name}} has moved the balances since claiming this place, so it cannot go back on the list. You can remove them instead - their expenses stay.',
    detachFailedTitle: 'Could not free up the place',
    memberRole: 'Member',
    owner: 'Owner',
  ...
  inbox: {
    ...
    emptyBody: 'Forwarded booking emails show up here as proposals to review.',
    noSubject: '(no subject)',
    parsing: 'Analysing…',
    noEvents: 'Nothing extracted',
    receivedFrom: 'From {{sender}}',
    eventCount_one: '{{count}} event',
    eventCount_other: '{{count}} events',
    notFound: 'Proposal not found.',
    securityTitle: 'External content',
    securityBody: 'Verify the sender before acting on this proposal.',
    senderLabel: 'From {{sender}}',
    validate: 'Add to timeline',
    validating: 'Adding…',
    validateError: 'Could not add these events',
    reject: 'Reject',
    rejecting: 'Rejecting…',
    rejectConfirmTitle: 'Reject this proposal?',
    rejectConfirmBody: 'The extracted events will not be added to the trip. This cannot be undone.',
    rejectError: 'Could not reject this proposal',
  },
}
